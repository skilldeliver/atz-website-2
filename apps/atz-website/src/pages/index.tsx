      ...
      <Container sx={{ mt: 8 }}>
        <Grid2 container spacing={4}>
          ...
          <Grid2 item xs={12} sm={7}>
            <Typography gutterBottom>
              We created AlphaTradeZone® in 2017. Our mission is to SAVE TIME
              and EFFORT to novice and advanced crypto traders and help boosting
          ...
          <Grid2 item xs={12} sm={6}>
            ...
            <Box sx={{ height: 336, backgroundColor: "black", width: "100%" }}>
              s
            </Box>
          </Grid2>
          <Grid2 item xs={12} sm={6}>
